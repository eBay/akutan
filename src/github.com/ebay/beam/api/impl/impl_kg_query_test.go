...
func Test_ToKGValue(t *testing.T) {
	...
	tests := []test{{
		...
		expected: api.KGValue{Value: &api.KGValue_Node{Node: &api.KGID{QName: "rdf:type", BeamId: 42}}},
	}, {
		...
		expected: api.KGValue{Value: &api.KGValue_Int64{Int64: &api.KGInt64{
			Value: 42, Unit: &api.KGID{QName: "<inch>", BeamId: 10},
		}}},
	}, {
		...
		expected: api.KGValue{Value: &api.KGValue_Bool{Bool: &api.KGBool{
			Value: true, Unit: &api.KGID{QName: "<inch>", BeamId: 11},
		}}},
	}, {
		...
		expected: api.KGValue{Value: &api.KGValue_Str{Str: &api.KGString{
			Value: "Alice", Lang: &api.KGID{QName: "en", BeamId: 11},
		}}},
	}, {
