...
// Package api contains ProtoBuf-generated types for the external gRPC API to Beam.
package api
...
API types are defined in proto/api/beam_api.proto file

logentry types are defined in the logentry package, see
src/github.com/ebay/beam/logentry/commands.proto

rpc types are defined in the rpc package, see
src/github.com/ebay/beam/rpc/views.proto
