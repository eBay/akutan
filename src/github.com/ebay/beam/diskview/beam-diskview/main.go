...
// Command beam-diskview runs a DiskView daemon.
package main
...
import (
	...
	"github.com/ebay/beam/diskview"
	_ "github.com/ebay/beam/diskview/rocksdb" // side-effect: registers "rocksdb" database implementation
...
func main() {
	...
	tracer, err := tracing.New("beam-diskview", cfg.Tracing)
	if err != nil {
	...
	signals.WaitForQuit()
	log.Info("Beam DiskView Exiting")
}
