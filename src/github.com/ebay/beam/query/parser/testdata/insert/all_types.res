Parsed:
_ #1001 #1002 #1003
_ beam:qname1 beam:qname2 beam:qname3
_ <entity1> <entity2> <entity3>
?var <a> <b> <c>
_ ?var #1002 ?var
_ beam:qname1 beam:qname2 true
_ beam:qname1 beam:qname2 12
_ beam:qname1 beam:qname2 12.230000
_ beam:qname1 beam:qname2 "banana"
_ beam:qname1 beam:qname2 '2017-01-03' (y-m-d)
_ beam:qname1 beam:qname2 true^^isEmpty
_ beam:qname1 beam:qname2 12^^inch
_ beam:qname1 beam:qname2 12.230000^^inch
_ beam:qname1 beam:qname2 "banana"@en_US
_ beam:qname1 beam:qname2 '2017-01-03' (y-m-d)^^{0 dateOfBirth}
  ...
  Facts: ([]*parser.Quad) (len=15) {
    ...
    (*parser.Quad)({
      ...
      Subject: (*parser.QName)({
        ID: (uint64) 0,
        Value: (string) (len=11) "beam:qname1"
      }),
      Predicate: (*parser.QName)({
        ID: (uint64) 0,
        Value: (string) (len=11) "beam:qname2"
      }),
      Object: (*parser.QName)({
        ID: (uint64) 0,
        Value: (string) (len=11) "beam:qname3"
      }),
      Specificity: (parser.MatchSpecificity) 0
    }),
    (*parser.Quad)({
