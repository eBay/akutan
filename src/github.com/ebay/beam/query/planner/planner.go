...
// Package planner is the KG/Beam-specific query optimizer. It defines the
// logical and physical transformation rules for KG/Beam's logical and physical
// operators, and it leverages the search subpackage to find the best
// implementation plan. This package also implements KG/Beam-specific cost
