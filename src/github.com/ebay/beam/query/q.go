...
// Package query provides a high level entry point for executing BeamQL queries.
...
import (
	...
	"github.com/ebay/beam/query/internal/debug"
	...
	"github.com/ebay/beam/util/graphviz"
