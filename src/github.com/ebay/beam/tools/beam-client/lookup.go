...
func lookupPO(ctx context.Context, store api.BeamFactStoreClient, options *options) error {
...
func lookupSP(ctx context.Context, store api.BeamFactStoreClient, options *options) error {
