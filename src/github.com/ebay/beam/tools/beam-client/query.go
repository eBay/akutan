...
func query(ctx context.Context, store api.BeamFactStoreClient, options *options) error {
...
func queryFacts(ctx context.Context, store api.BeamFactStoreClient, options *options) error {
